...
# =============================================================================
    ...
    def get_TOAs(self, datafile_band3=None, datafile_band5=None, tscrunch=False, nu_refs=None, DM0=None,
            ...
            method='trust-ncg', bounds=None, nu_fits=None, show_plot=True,
            quiet=None):
        """
            ...
            if not show_plot:
                ...
                for isub in d3.ok_isubs:
                    if show_plot=="save":
                        ...
                        savefig_band3 = False
                    self.show_fit(datafile_band3, isub, savefig=savefig_band3)
                    self.show_fit(datafile_band5, isub, savefig=savefig_band5)
                start = time.time()
            if show_plot:
...
#Avinash
    ...
    parser.add_option("--showplot",
                      action="store_true", dest="show_plot", default=True,
    ...
    parser.add_option("--saveplot",
                      action="store_true", dest="save_plot", default=True,
