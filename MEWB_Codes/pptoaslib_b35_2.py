...
def fit_portrait_full_function(params, data_portrait_FT, 
                               model_portrait_FT,
                               errs_FT, P, freqs, 
...
def fit_portrait_full_function_2deriv_with_scales_band35(params, data_portrait_FT_band3, data_portrait_FT_band5,
                                                  model_portrait_FT_band3, model_portrait_FT_band5, 
                                                  errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, 
                                                  nu_DM, nu_GM, nu_tau,
                                                  fit_flags, log10_tau, phase_offset, per_channel=False,
                                                  return_covariance_matrix=False, return_scales=False):
    """
    """
    params_band3 = np.copy(params)
    params_band5 = np.copy(params)
    params_band3[0]=params_band3[0]
    params_band5[0]=params_band5[0]+phase_offset
    
    returns = []
    phi_band3, DM, GM, tau, alpha = params
    phi_band5 = phi_band3+phase_offset
    if log10_tau: tau = 10 ** tau
    data_port_FT_band3 = data_portrait_FT_band3
    data_port_FT_band5 = data_portrait_FT_band5
    model_port_FT_band3 = model_portrait_FT_band3
    model_port_FT_band5 = model_portrait_FT_band5
    nharm_band3 = data_portrait_FT_band3.shape[-1]
    nharm_band5 = data_portrait_FT_band5.shape[-1]
    nbin_band3 = 2 * (nharm_band3 - 1)
    nbin_band5 = 2 * (nharm_band5 - 1)
    freqs = np.concatenate((freqs_band3,freqs_band5),axis=0)
    phis_band3 = phase_shifts(phi_band3, DM, GM, freqs_band3, nu_DM, nu_GM, P, mod=False)
    phis_deriv_band3 = phase_shifts_deriv(freqs_band3, nu_DM, nu_GM, P)
    phis_2deriv_band3 = phase_shifts_2deriv(freqs_band3, nu_GM, P)
    phis_band5 = phase_shifts(phi_band5, DM, GM, freqs_band5, nu_DM, nu_GM, P, mod=False)
    phis_deriv_band5 = phase_shifts_deriv(freqs_band5, nu_DM, nu_GM, P)
    phis_2deriv_band5 = phase_shifts_2deriv(freqs_band5, nu_GM, P)
    print("Done")
    phsr_band3 = phasor(phis_band3, nharm_band3)
    phsr_band5 = phasor(phis_band5, nharm_band5)
    taus_band3 = scattering_times(tau, alpha, freqs_band3, nu_tau)
    taus_band5 = scattering_times(tau, alpha, freqs_band5, nu_tau)
    taus_deriv_band3 = scattering_times_deriv(tau, freqs_band3, nu_tau, log10_tau, taus_band3)
    taus_deriv_band5 = scattering_times_deriv(tau, freqs_band5, nu_tau, log10_tau, taus_band5)
    taus_2deriv_band3 = scattering_times_2deriv(tau, freqs_band3, nu_tau, log10_tau, taus_band3,
                                          taus_deriv_band3)
    taus_2deriv_band5 = scattering_times_2deriv(tau, freqs_band5, nu_tau, log10_tau, taus_band5,
                                          taus_deriv_band5)
    scat_port_FT_band3 = scattering_portrait_FT(taus_band3, nbin_band3, binshift=binshift)
    scat_port_FT_band5 = scattering_portrait_FT(taus_band5, nbin_band5, binshift=binshift)
    scat_port_FT_deriv_band3 = scattering_portrait_FT_deriv(taus_band3, taus_deriv_band3,
                                                      scat_port_FT_band3)
    scat_port_FT_deriv_band5 = scattering_portrait_FT_deriv(taus_band5, taus_deriv_band5,
                                                      scat_port_FT_band5)
    scat_port_FT_2deriv_band3 = scattering_portrait_FT_2deriv(taus_band3, taus_deriv_band3,
                                                        taus_2deriv_band3, scat_port_FT_band3)
    scat_port_FT_2deriv_band5 = scattering_portrait_FT_2deriv(taus_band5, taus_deriv_band5,
                                                        taus_2deriv_band5, scat_port_FT_band5)
    abs_scat_port_FT_deriv_band3 = abs_scattering_portrait_FT_deriv(scat_port_FT_band3,
                                                              scat_port_FT_deriv_band3)
    abs_scat_port_FT_deriv_band5 = abs_scattering_portrait_FT_deriv(scat_port_FT_band5,
                                                              scat_port_FT_deriv_band5)
    abs_scat_port_FT_2deriv_band3 = abs_scattering_portrait_FT_2deriv(scat_port_FT_band3,
                                                                scat_port_FT_deriv_band3, scat_port_FT_2deriv_band3)
    abs_scat_port_FT_2deriv_band5 = abs_scattering_portrait_FT_2deriv(scat_port_FT_band5,
                                                                scat_port_FT_deriv_band5, scat_port_FT_2deriv_band5)
    S_band3 = Sbp(scat_port_FT_band3, model_port_FT_band3, errs_FT_band3)
    dS_band3 = Sbp_deriv(abs_scat_port_FT_deriv_band3, model_port_FT_band3, errs_FT_band3)
    d2S_band3 = Sbp_2deriv(abs_scat_port_FT_2deriv_band3, model_port_FT_band3, errs_FT_band3)
    C_band3 = Cdbp(data_port_FT_band3, model_port_FT_band3, scat_port_FT_band3, phsr_band3, errs_FT_band3)
    dCdphi_band3 = Cdbp_deriv_phase_shifts(data_port_FT_band3, model_port_FT_band3, scat_port_FT_band3,
                                     phsr_band3)
    d2Cdphi_band3 = Cdbp_2deriv_phase_shifts(data_port_FT_band3, model_port_FT_band3,
                                       scat_port_FT_band3, phsr_band3)
    dC_band3 = Cdbp_deriv(data_port_FT_band3, model_port_FT_band3, scat_port_FT_deriv_band3, phsr_band3,
                    phis_deriv_band3, dCdphi_band3, errs_FT_band3)
    d2C_band3 = Cdbp_2deriv(data_port_FT_band3, model_port_FT_band3, scat_port_FT_deriv_band3,
                      scat_port_FT_2deriv_band3, phsr_band3, phis_deriv_band3, phis_2deriv_band3, dCdphi_band3,
                      d2Cdphi_band3, errs_FT_band3)
    
    S_band5 = Sbp(scat_port_FT_band5, model_port_FT_band5, errs_FT_band5)
    dS_band5 = Sbp_deriv(abs_scat_port_FT_deriv_band5, model_port_FT_band5, errs_FT_band5)
    d2S_band5 = Sbp_2deriv(abs_scat_port_FT_2deriv_band5, model_port_FT_band5, errs_FT_band5)
    C_band5 = Cdbp(data_port_FT_band5, model_port_FT_band5, scat_port_FT_band5, phsr_band5, errs_FT_band5)
    dCdphi_band5 = Cdbp_deriv_phase_shifts(data_port_FT_band5, model_port_FT_band5, scat_port_FT_band5,
                                     phsr_band5)
    d2Cdphi_band5 = Cdbp_2deriv_phase_shifts(data_port_FT_band5, model_port_FT_band5,
                                       scat_port_FT_band5, phsr_band5)
    dC_band5 = Cdbp_deriv(data_port_FT_band5, model_port_FT_band5, scat_port_FT_deriv_band5, phsr_band5,
                    phis_deriv_band5, dCdphi_band5, errs_FT_band5)
    d2C_band5 = Cdbp_2deriv(data_port_FT_band5, model_port_FT_band5, scat_port_FT_deriv_band5,
                      scat_port_FT_2deriv_band5, phsr_band5, phis_deriv_band5, phis_2deriv_band5, dCdphi_band5,
                      d2Cdphi_band5, errs_FT_band5)
    
    S = np.concatenate((S_band3,S_band5),axis=0)
    dS = np.concatenate((dS_band3,dS_band5),axis=1)
    d2S = np.concatenate((d2S_band3,d2S_band5),axis=2)
    C = np.concatenate((C_band3,C_band5),axis=0)
    dCdphi = np.concatenate((dCdphi_band3,dCdphi_band5),axis=0)
    d2Cdphi = np.concatenate((d2Cdphi_band3,d2Cdphi_band5),axis=0)
    dC = np.concatenate((dC_band3,dC_band5),axis=1)
    d2C = np.concatenate((d2C_band3,d2C_band5),axis=2)
...
def get_nu_zeros(params, data_portrait_FT_band3, data_portrait_FT_band5, 
                 model_portrait_FT_band3, model_portrait_FT_band5, 
                 errs_FT_band3, errs_FT_band5, P,
                 freqs_band3, freqs_band5, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau, phase_offset, option=0):
    """
    """
    params_band3 = np.copy(params)
    params_band5 = np.copy(params)
    ...
    phi, DM, GM, tau, alpha = params
    if log10_tau: tau = 10 ** tau
    Hij_n_b3 = fit_portrait_full_function_2deriv(params_band3, data_portrait_FT_band3,
                                              model_portrait_FT_band3, errs_FT_band3, P, freqs_band3, 
                                              nu_DM, nu_GM, nu_tau,
                                              fit_flags, log10_tau, per_channel=True, return_covariance_matrix=False,
                                              return_scales=False)
    Hij_n_b5 = fit_portrait_full_function_2deriv(params_band5, data_portrait_FT_band5,
                                              model_portrait_FT_band5, errs_FT_band5, P, freqs_band5, 
                                              nu_DM, nu_GM, nu_tau,
                                              fit_flags, log10_tau, per_channel=True, return_covariance_matrix=False,
                                              return_scales=False)
    freqs = np.concatenate((freqs_band3,freqs_band5),axis =0)
    Hij_n = np.concatenate((Hij_n_b3,Hij_n_b5),axis = 2)
    phis_deriv = phase_shifts_deriv(freqs, nu_DM, nu_GM, P)
    taus = scattering_times(tau, alpha, freqs, nu_tau)
    taus_deriv = scattering_times_deriv(tau, freqs, nu_tau, log10_tau, taus)
    if np.all(fit_flags == [1, 1, 0, 0, 0]):  # only phi and DM, 'original'
        ...
        print("all fit flag option not available")
        print(ok)
...
def fit_portrait_full_function_band35(params, data_portrait_FT_band3, data_portrait_FT_band5, 
                               model_portrait_FT_band3, model_portrait_FT_band5,
                               errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, 
                               nu_DM, nu_GM, nu_tau, fit_flags, log10_tau, phase_offset):
    
    #print("params",params)
    params_band3 = np.copy(params)
    params_band5 = np.copy(params)
    #print("band3_p0",params_band3[0])
    params_band3[0]=params_band3[0]
    #print("band3_p0",params_band3[0])
    #print("band5_p0",params_band5[0])
    params_band5[0]=params_band5[0]+phase_offset
    #print("band5_p0",params_band5[0])
    #print(params_band5)
    
    #print("paramsb3 in chisqr",*params_band3)
    #print("paramsb5 in chisqr",*params_band5)
    chi2_prime_band3 = fit_portrait_full_function(params_band3, data_portrait_FT_band3, model_portrait_FT_band3,
                                   errs_FT_band3, P, freqs_band3, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau)
    chi2_prime_band5 = fit_portrait_full_function(params_band5, data_portrait_FT_band5, model_portrait_FT_band5,
                                   errs_FT_band5, P, freqs_band5, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau)
    chi2_prime_band35 = chi2_prime_band3 + chi2_prime_band5
    
    #print("chi2_band3",chi2_prime_band3)
    #print("chi2_band5",chi2_prime_band5)
    #print("chi2_band35",chi2_prime_band35)
    
    # temp_data_port_band3 = fft.irfft(data_portrait_FT_band3, axis=-1)
    # temp_data_port_band5 = fft.irfft(data_portrait_FT_band5, axis=-1)
    # temp_model_port_band3 = fft.irfft(model_portrait_FT_band3, axis=-1)
    # temp_model_port_band5 = fft.irfft(model_portrait_FT_band5, axis=-1)
    
    
    
    # trot_port_band3 = rotate_data(temp_data_port_band3, params_band3[0], params_band3[1], P, freqs_band3,
    #                         nu_DM)  # why not nu_fit?
    # trot_port_band5 = rotate_data(temp_data_port_band5, params_band5[0], params_band5[1], P, freqs_band5,
    #                         nu_DM)  # why not nu_fit?
    
    # plt.plot(figsize=(20,20))
    # plt.imshow(temp_data_port_band3,extent=(0,1,0,32), aspect='auto')
    # plt.title("portx_34")
    # plt.xlabel('nbin')
    # plt.ylabel('nchan')
    # plt.show()
    # plt.plot(figsize=(20,20))
    # plt.imshow(temp_data_port_band5,extent=(0,1,0,32), aspect='auto')
    # plt.title("portx_45")
    # plt.xlabel('nbin')
    # plt.ylabel('nchan')
    # plt.show()
    # plt.plot(figsize=(20,20))
    # plt.imshow(temp_model_port_band3,extent=(0,1,0,32), aspect='auto')
    # plt.title("modelx_34")
    # plt.xlabel('nbin')
    # plt.ylabel('nchan')
    # plt.show()
    # plt.plot(figsize=(20,20))
    # plt.imshow(temp_model_port_band5,extent=(0,1,0,32), aspect='auto')
    # plt.title("modelx_45")
    # plt.xlabel('nbin')
    # plt.ylabel('nchan')
    # plt.show()
    # plt.plot(figsize=(20,20))
    # plt.imshow(trot_port_band3,extent=(0,1,0,64), aspect='auto')
    # plt.title("rot_port_34")
    # plt.xlabel('nbin')
    # plt.ylabel('nchan')
    # plt.show()
    # plt.plot(figsize=(20,20))
    # plt.imshow(trot_port_band5,extent=(0,1,0,64), aspect='auto')
    # plt.title("rot_port_45")
    # plt.xlabel('nbin')
    # plt.ylabel('nchan')
    # plt.show()
    # print(ok)
    return chi2_prime_band35
    
def fit_portrait_full_function_deriv_band35(params, data_portrait_FT_band3, data_portrait_FT_band5, 
                                     model_portrait_FT_band3, model_portrait_FT_band5,
                                     errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, 
                                     nu_DM, nu_GM, nu_tau, fit_flags, log10_tau, phase_offset):
    params_band3 = np.copy(params)
    ...
    gradient_band3 = fit_portrait_full_function_deriv(params_band3, data_portrait_FT_band3,
                                         model_portrait_FT_band3, errs_FT_band3, P, freqs_band3, nu_DM, nu_GM, nu_tau,
                                         fit_flags, log10_tau)
    gradient_band5 = fit_portrait_full_function_deriv(params_band5, data_portrait_FT_band5,
                                         model_portrait_FT_band5, errs_FT_band5, P, freqs_band5, nu_DM, nu_GM, nu_tau,
                                         fit_flags, log10_tau)
    gradient_band35 = gradient_band3 + gradient_band5
    #print("gradient",gradient_band3)
    #print("gradient_band35",gradient_band35)
    return gradient_band35

def fit_portrait_full_function_2deriv_band35(params, data_portrait_FT_band3, data_portrait_FT_band5, 
                                      model_portrait_FT_band3, model_portrait_FT_band5,
                                      errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, 
                                      nu_DM, nu_GM, nu_tau, fit_flags, log10_tau, phase_offset, per_channel=False,
                                      return_covariance_matrix=False, return_scales=False):
    params_band3 = np.copy(params)
    params_band5 = np.copy(params)
    params_band3[0]=params_band3[0]
    ...
    hessian_band3 = fit_portrait_full_function_2deriv(params_band3, data_portrait_FT_band3,
                                          model_portrait_FT_band3, errs_FT_band3, P, freqs_band3, nu_DM, nu_GM, nu_tau,
                                          fit_flags, log10_tau, per_channel=False,
                                          return_covariance_matrix=False, return_scales=False)
    hessian_band5 = fit_portrait_full_function_2deriv(params_band5, data_portrait_FT_band5,
                                          model_portrait_FT_band5, errs_FT_band5, P, freqs_band5, nu_DM, nu_GM, nu_tau,
                                          fit_flags, log10_tau, per_channel=False,
                                          return_covariance_matrix=False, return_scales=False)

    hessian_band35 = hessian_band3 + hessian_band5
    #print("hessian",hessian_band3)
    #print("hessian_band35",hessian_band35)
    return hessian_band35

# =============================================================================
# def fit_portrait_full_function_2deriv_with_scales_band35(params, data_portrait_FT_band3, data_portrait_FT_band5, 
#                                       model_portrait_FT_band3, model_portrait_FT_band5,
#                                       errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, 
#                                       nu_DM, nu_GM, nu_tau, fit_flags, log10_tau, per_channel=False,
#                                       return_covariance_matrix=False, return_scales=False):
#     Hij_b3, covariance_matrix_b3, scales_b3 = fit_portrait_full_function_2deriv_with_scales(params, data_portrait_FT_band3,
#                                           model_portrait_FT_band3, errs_FT_band3, P, freqs_band3, nu_DM, nu_GM, nu_tau,
#                                           fit_flags, log10_tau, per_channel=False,
#                                           return_covariance_matrix=True, return_scales=True)
#     Hij_b5, covariance_matrix_b5, scales_b5 = fit_portrait_full_function_2deriv_with_scales(params, data_portrait_FT_band5,
#                                           model_portrait_FT_band5, errs_FT_band5, P, freqs_band5, nu_DM, nu_GM, nu_tau,
#                                           fit_flags, log10_tau, per_channel=False,
#                                           return_covariance_matrix=True, return_scales=True)
# 
#     
#     print("Hij_b3",Hij_b3)
#     print("cov_b3",covariance_matrix_b3)
#     print("scal_b3",scales_b3)
#     print("Hij_b3",np.shape(Hij_b3))
#     print("cov_b3",np.shape(covariance_matrix_b3))
#     print("scal_b3",np.shape(scales_b3))
#     print("Hij_b5",np.shape(Hij_b5))
#     print("cov_b5",np.shape(covariance_matrix_b5))
#     print("scal_b5",np.shape(scales_b5))
#     print("ok")
#     return Hij, covariance_matrix, scales
# =============================================================================

def fit_portrait_full(data_port_band3, data_port_band5, model_port_band3, model_port_band5,
                      init_params, P, phase_offset, freqs_band3, freqs_band5,
                      nu_fits=[None, None, None], nu_outs=[None, None, None], 
                      errs_band3=None, errs_band5=None,
                      fit_flags=[1, 1, 1, 1, 1], bounds=[(None, None), (None, None),
                                                         (None, None), (None, None), (None, None)], log10_tau=True,
                      option=0, sub_id_band3=None, sub_id_band5=None, 
                      method='trust-ncg', is_toa=True, quiet=True):
    #print(nu_fits)
    ...
    """
    sub_id = sub_id_band3+"_"+sub_id_band5
    ifit = np.where(fit_flags)[0]  # which parameters are fitnfit
    nfit = len(ifit)  # not including the scale parameters a_n
    dof = len(data_port_band3.ravel()) + len(data_port_band5.ravel()) - (nfit + len(freqs_band3) + len(freqs_band5))
    nbin_band3 = data_port_band3.shape[-1]
    nbin_band5 = data_port_band5.shape[-1]
    data_port_FT_band3 = fft.rfft(data_port_band3, axis=-1)
    data_port_FT_band5 = fft.rfft(data_port_band5, axis=-1)
...
#     temp_phase = -1*(72630.0117258624 - 72630.01012435199)/P
#     trot_port_band3 = rotate_data(data_port_band3, init_params[0], init_params[1], P, freqs_band3,
#                            nu_fit_DM)  # why not nu_fit?
#     trot_port_band5 = rotate_data(data_port_band5, init_params[0]+temp_phase, init_params[1], P, freqs_band5,
#                            nu_fit_DM)  # why not nu_fit?
#     
#     plt.plot(figsize=(20,20))
#     plt.imshow(data_port_band3,extent=(0,1,0,32), aspect='auto')
#     plt.title("portx_34")
#     plt.xlabel('nbin')
#     plt.ylabel('nchan')
#     plt.show()
#     plt.plot(figsize=(20,20))
#     plt.imshow(data_port_band5,extent=(0,1,0,32), aspect='auto')
#     plt.title("portx_45")
#     plt.xlabel('nbin')
#     plt.ylabel('nchan')
#     plt.show()
#     plt.plot(figsize=(20,20))
#     plt.imshow(model_port_band3,extent=(0,1,0,32), aspect='auto')
#     plt.title("modelx_34")
#     plt.xlabel('nbin')
#     plt.ylabel('nchan')
#     plt.show()
#     plt.plot(figsize=(20,20))
#     plt.imshow(model_port_band5,extent=(0,1,0,32), aspect='auto')
#     plt.title("modelx_45")
#     plt.xlabel('nbin')
#     plt.ylabel('nchan')
#     plt.show()
...
# =============================================================================
#     print(np.shape(data_port_FT_band5))
#     plt.plot(figsize=(20,20))
#     plt.imshow(data_port_band3,extent=(0,1,0,64), aspect='auto')
#     plt.title("rot_port_45")
#     plt.xlabel('nbin')
#     plt.ylabel('nchan')
#     plt.show()
#     plt.plot(figsize=(20,20))
#     plt.imshow(np.abs(data_port_FT_band3),extent=(0,1,0,64), aspect='auto')
#     plt.title("rot_port_45")
#     plt.xlabel('nbin')
#     plt.ylabel('nchan')
#     plt.show()
# =============================================================================
    ...
    ## We have taken F0_fact ==1 for background subtraction
    data_port_FT_band3[:, 0] *= F0_fact
    data_port_FT_band5[:, 0] *= F0_fact
# =============================================================================
#     print(np.shape(data_port_FT_band5))
#     plt.plot(figsize=(20,20))
#     plt.imshow(data_port_band3,extent=(0,1,0,64), aspect='auto')
...
#     print(ok)
#     print("imp")
#     print(data_port_FT_band5[:, 0])
# =============================================================================
    model_port_FT_band3 = fft.rfft(model_port_band3, axis=-1)
    model_port_FT_band5 = fft.rfft(model_port_band5, axis=-1)
    model_port_FT_band3[:, 0] *= F0_fact
    model_port_FT_band5[:, 0] *= F0_fact
    if errs_band3 is None:
        errs_FT_band3 = get_noise(data_port_band3, chans=True) * \
                  np.sqrt(len(data_port_band3[0]) / 2.0)
    else:
        errs_FT_band3 = errs_band3 * np.sqrt(len(data_port_band3[0]) / 2.0)
    if errs_band5 is None:
        errs_FT_band5 = get_noise(data_port_band5, chans=True) * \
                  np.sqrt(len(data_port_band5[0]) / 2.0)
    else:
        errs_FT_band5 = errs_band5 * np.sqrt(len(data_port_band5[0]) / 2.0)
# =============================================================================
#     print("avinash: errs_FT_band3",errs_FT_band3,errs_FT_band3.shape)
#     print("avinash: errs_FT_band5",errs_FT_band5,errs_FT_band5.shape)
#     print(ok)
# =============================================================================
    Sd_band3 = (old_div((np.abs(data_port_FT_band3) ** 2).T, errs_FT_band3 ** 2.0)).T.sum()
    Sd_band5 = (old_div((np.abs(data_port_FT_band5) ** 2).T, errs_FT_band5 ** 2.0)).T.sum()
    Sd = Sd_band3+Sd_band5
    nu_fit_DM, nu_fit_GM, nu_fit_tau = nu_fits
    ...
    other_args = (data_port_FT_band3, data_port_FT_band5, model_port_FT_band3, model_port_FT_band5,
                  errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, nu_fit_DM,
                  nu_fit_GM, nu_fit_tau, list(map(bool, fit_flags)), log10_tau, phase_offset)
    minimize = opt.minimize
    ##check jac, hess, chisqr later
    jac = fit_portrait_full_function_deriv_band35
    if method != 'TNC':
        bounds = None
        hess = fit_portrait_full_function_2deriv_band35
    else:
        bounds = bounds
        hess = None
    if method == 'trust-ncg':
        ...
        sys.exit()
    start = time.time()
    results = minimize(fit_portrait_full_function_band35, init_params,
    ...
    print("avinash: results.x",results.x)
    # print(ok)
    if not bool(np.all(nu_outs)):
        nu_zero_DM, nu_zero_GM, nu_zero_tau = get_nu_zeros(results.x,
                                                           data_port_FT_band3, data_port_FT_band5, 
                                                           model_port_FT_band3, model_port_FT_band5,
                                                           errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5,
                                                           nu_fit_DM,
                                                           nu_fit_GM, nu_fit_tau, fit_flags, log10_tau, phase_offset, option=option)
    ...
    taus_band3 = scattering_times(tau_out, alpha_fit, freqs_band3, nu_out_tau)
    taus_band5 = scattering_times(tau_out, alpha_fit, freqs_band5, nu_out_tau)
    if log10_tau:
    ...
    Hij, covariance_matrix, scales = \
        fit_portrait_full_function_2deriv_with_scales_band35(params,
                                                      data_port_FT_band3, data_port_FT_band5, 
                                                      model_port_FT_band3, model_port_FT_band5,
                                                      errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5,
                                                      nu_out_DM, nu_out_GM, nu_out_tau, fit_flags, log10_tau, phase_offset,
